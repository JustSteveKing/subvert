    ...
    <div class="max-w-3xl mx-auto my-12">
        <div class="text-center mb-8">
            ...
            @if ($process->transcript)
                <button class="flex items-center mx-auto text-sm font-semibold text-white bg-black rounded-full px-4 py-2 hover:bg-purple-500 transition-colors duration-200"
